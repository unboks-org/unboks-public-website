...
export const t: Record<Lang, Record<string, string>> = {
  pap: {
    ...
    step2_p:        'Nos ta konektá bo kanalnan, krea bo Source of Truth — un base di konosementu spesífiko pa bo negoshi ku ta duna kontesta korekto — i pone regla pa ordená, sigui i manda mensahenan pa e persona korekto.',
  ...
  en: {
    ...
    step2_p:        'We connect your channels, build your Source of Truth — a per-client knowledge base that powers accurate answers — and set rules for sorting, following up, and forwarding messages.',
  ...
  es: {
    ...
    step2_p:        'Conectamos tus canales, construimos tu Source of Truth — una base de conocimiento específica de tu negocio que alimenta respuestas precisas — y configuramos reglas para ordenar, hacer seguimiento y reenviar mensajes.',
  ...
  nl: {
    ...
    step2_p:        'We koppelen je kanalen, bouwen je Source of Truth — een kennisbank per klant die accurate antwoorden mogelijk maakt — en stellen regels in voor sorteren, opvolgen en doorzetten.',
  ...
  sv: {
    ...
    step2_p:        'Vi kopplar dina kanaler, bygger din Source of Truth — en kunskapsbas per kund som ger korrekta svar — och sätter regler för sortering, uppföljning och vidarebefordran.',
