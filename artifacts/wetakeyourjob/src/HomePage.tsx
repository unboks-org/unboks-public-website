    ...
    <div className="hp-site">
      ...
      <div className="channels">
        ...
        <div className="channel-pills">
          ...
          <span className="pill">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="#000000"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.747l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
          </span>
        </div>
      </div>
      ...
      <div className="cta-band" id="contact">
        ...
        <div className="cta-actions">
          <a href="/signup" className="btn-whatsapp">Start 14-Day Free Trial</a>
        </div>
      </div>
