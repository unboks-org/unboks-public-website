    ...
    <div className="hp-site">
      ...
      <nav>
        ...
        <div className="nav-links">
          ...
          <a href="/contact" aria-current="page">{tx.nav_contact}</a>
        </div>
      ...
      <section className="contact-hero">
        <div className="contact-tag">{tx.contact_tag}</div>
        <h1 className="contact-h1">{tx.contact_h1}</h1>
        <p className="contact-sub">{tx.contact_sub}</p>
      </section>
      ...
      <div className="contact-cards">
        ...
        >
          ...
          <div className="contact-card-body">
            <div className="contact-card-title">{tx.contact_wa_title}</div>
            <div className="contact-card-sub">{tx.contact_wa_sub}</div>
            <div className="contact-card-value">+599 968 81585</div>
          </div>
          <div className="contact-card-arrow">→</div>
        </a>

        <a
          href="mailto:hello@unboks.org"
        ...
        >
          ...
          <div className="contact-card-body">
            <div className="contact-card-title">{tx.contact_email_title}</div>
            <div className="contact-card-sub">{tx.contact_email_sub}</div>
            <div className="contact-card-value">hello@unboks.org</div>
          </div>
          <div className="contact-card-arrow">→</div>
        </a>
      </div>
